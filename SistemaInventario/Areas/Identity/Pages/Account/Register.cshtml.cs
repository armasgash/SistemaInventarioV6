...
namespace SistemaInventario.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            //ACA SE AGREGAN LOS CAMPOS ADICIONALES QUE SE METIERON PARA USUARIO SE DEBE HACER MANUALMENTE
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (!await _roleManager.RoleExistsAsync(DS.Role_Vendedor))
                    {
                ...
                //ACA SE DEBE VOLVER A CARGAR LA LISTA DE ROLES
                Input = new InputModel()
                {
                    ListaRol = _roleManager.Roles.Where(r => r.Name != DS.Role_Cliente).Select(n => n.Name).Select(l => new SelectListItem
                    {
